## Generated SDC file "AN511_SMM_CM3DS.sdc"
...
create_clock -name {zbt_virtual_clock} -period 40.000 -waveform { 0.000 20.000 }
...
create_generated_clock -name {RTC_1HZ_CLK} -source [get_pins {u_fpga_pll|u_cpu_periph_clk_pll_1|auto_generated|generic_pll2~PLL_OUTPUT_COUNTER|divclk}] -divide_by 3072 -master_clock {AUDSCLK} [get_pins {u_fpga_system|u_user_partition|rtc_1hz_clk|q}]
create_generated_clock -name {TRNG_ENTROPY_CLK} -source [get_pins {u_fpga_pll|u_cpu_periph_clk_pll_0|auto_generated|generic_pll1~PLL_OUTPUT_COUNTER|divclk}] -master_clock {SYSCLK} [get_pins {u_fpga_system|u_user_partition|u_mps2_peripherals_wrapper|u_beetle_peripherals_fpga_subsystem|u_trng|rosc_i|u_entropy|out|q}]
create_generated_clock -name {TRNG_DIV_2_CLK} -source [get_pins {u_fpga_system|u_user_partition|u_mps2_peripherals_wrapper|u_beetle_peripherals_fpga_subsystem|u_trng|rosc_i|u_entropy|out|q}] -divide_by 2 -master_clock {TRNG_ENTROPY_CLK} [get_pins {u_fpga_system|u_user_partition|u_mps2_peripherals_wrapper|u_beetle_peripherals_fpga_subsystem|u_trng|rng_engine_i|rng_top_i|trng_top_i|trng_sync_i|rnd_src_div_2|q}]
create_generated_clock -name {TRNG_DIV_4_CLK} -source [get_pins {u_fpga_system|u_user_partition|u_mps2_peripherals_wrapper|u_beetle_peripherals_fpga_subsystem|u_trng|rng_engine_i|rng_top_i|trng_top_i|trng_sync_i|rnd_src_div_2|q}] -divide_by 2 -master_clock {TRNG_DIV_2_CLK} [get_pins {u_fpga_system|u_user_partition|u_mps2_peripherals_wrapper|u_beetle_peripherals_fpga_subsystem|u_trng|rng_engine_i|rng_top_i|trng_top_i|trng_sync_i|rnd_src_div_4|q}]
create_generated_clock -name {TRNG_DIV_8_CLK} -source [get_pins {u_fpga_system|u_user_partition|u_mps2_peripherals_wrapper|u_beetle_peripherals_fpga_subsystem|u_trng|rng_engine_i|rng_top_i|trng_top_i|trng_sync_i|rnd_src_div_4|q}] -divide_by 2 -master_clock {TRNG_DIV_4_CLK} [get_pins {u_fpga_system|u_user_partition|u_mps2_peripherals_wrapper|u_beetle_peripherals_fpga_subsystem|u_trng|rng_engine_i|rng_top_i|trng_top_i|trng_sync_i|rnd_src_div_8|q}]
create_generated_clock -name {AUDSCLK_MUX} -source [get_pins -compatibility_mode {*u_apb_if|reg_itcr|clk}] -divide_by 100 -master_clock {SYSCLK} [get_pins {u_fpga_system|u_user_partition|u_mps2_peripherals_wrapper|u_fpga_ahb_to_apb_subsystem|u_apb_i2s_top|u_apb_if|reg_itcr|q}]

#create_generated_clock -name {TRACE_CLK} -source [get_pins {u_fpga_pll|u_cpu_periph_clk_pll_0|auto_generated|generic_pll1~PLL_OUTPUT_COUNTER|divclk}] -master_clock {SYSCLK} [get_pins {u_fpga_system|u_user_partition|u_iot_top|u_CORTEXM3INTEGRATION|u_cm3_tpiu|u_cm3_tpiu_trace_clk|trace_clk|q}]
# Note.  If obfuscated code regenerated, then the register name will change
# Determined by examining connection of TRACECLK in cortexm3ds_logic
create_generated_clock -name {TRACE_CLK} -source [get_pins {u_fpga_pll|u_cpu_periph_clk_pll_0|auto_generated|generic_pll1~PLL_OUTPUT_COUNTER|divclk}] -master_clock {SYSCLK} [get_registers *Su3nz6*]
...
create_generated_clock -name {u_fpga_pll|u_cpu_periph_clk_pll_2|auto_generated|generic_pll1~FRACTIONAL_PLL|vcoph[0]} -source [get_pins {u_fpga_pll|u_cpu_periph_clk_pll_2|auto_generated|generic_pll1~FRACTIONAL_PLL|refclkin}] -duty_cycle 50/1 -multiply_by 24 -divide_by 2 -master_clock {OSCCLK2} [get_pins {u_fpga_pll|u_cpu_periph_clk_pll_2|auto_generated|generic_pll1~FRACTIONAL_PLL|vcoph[0]}]
...
set_clock_uncertainty -rise_from [get_clocks {AUDSCLK}] -rise_to [get_clocks {RTC_1HZ_CLK}] -setup 0.190
set_clock_uncertainty -rise_from [get_clocks {AUDSCLK}] -rise_to [get_clocks {RTC_1HZ_CLK}] -hold 0.170
set_clock_uncertainty -rise_from [get_clocks {AUDSCLK}] -fall_to [get_clocks {RTC_1HZ_CLK}] -setup 0.190
set_clock_uncertainty -rise_from [get_clocks {AUDSCLK}] -fall_to [get_clocks {RTC_1HZ_CLK}] -hold 0.170
...
set_clock_uncertainty -fall_from [get_clocks {AUDSCLK}] -rise_to [get_clocks {RTC_1HZ_CLK}] -setup 0.190
set_clock_uncertainty -fall_from [get_clocks {AUDSCLK}] -rise_to [get_clocks {RTC_1HZ_CLK}] -hold 0.170
set_clock_uncertainty -fall_from [get_clocks {AUDSCLK}] -fall_to [get_clocks {RTC_1HZ_CLK}] -setup 0.190
set_clock_uncertainty -fall_from [get_clocks {AUDSCLK}] -fall_to [get_clocks {RTC_1HZ_CLK}] -hold 0.170
...
set_clock_uncertainty -rise_from [get_clocks {SYSCLK}] -rise_to [get_clocks {TRACE_CLK}] -setup 0.080
set_clock_uncertainty -rise_from [get_clocks {SYSCLK}] -rise_to [get_clocks {TRACE_CLK}] -hold 0.060
set_clock_uncertainty -rise_from [get_clocks {SYSCLK}] -fall_to [get_clocks {TRACE_CLK}] -setup 0.080
set_clock_uncertainty -rise_from [get_clocks {SYSCLK}] -fall_to [get_clocks {TRACE_CLK}] -hold 0.060
set_clock_uncertainty -rise_from [get_clocks {SYSCLK}] -rise_to [get_clocks {TRNG_DIV_8_CLK}] -setup 0.310
set_clock_uncertainty -rise_from [get_clocks {SYSCLK}] -rise_to [get_clocks {TRNG_DIV_8_CLK}] -hold 0.300
set_clock_uncertainty -rise_from [get_clocks {SYSCLK}] -fall_to [get_clocks {TRNG_DIV_8_CLK}] -setup 0.310
set_clock_uncertainty -rise_from [get_clocks {SYSCLK}] -fall_to [get_clocks {TRNG_DIV_8_CLK}] -hold 0.300
set_clock_uncertainty -rise_from [get_clocks {SYSCLK}] -rise_to [get_clocks {TRNG_DIV_4_CLK}] -setup 0.280
set_clock_uncertainty -rise_from [get_clocks {SYSCLK}] -rise_to [get_clocks {TRNG_DIV_4_CLK}] -hold 0.270
set_clock_uncertainty -rise_from [get_clocks {SYSCLK}] -fall_to [get_clocks {TRNG_DIV_4_CLK}] -setup 0.280
set_clock_uncertainty -rise_from [get_clocks {SYSCLK}] -fall_to [get_clocks {TRNG_DIV_4_CLK}] -hold 0.270
set_clock_uncertainty -rise_from [get_clocks {SYSCLK}] -rise_to [get_clocks {TRNG_DIV_2_CLK}] -setup 0.240
set_clock_uncertainty -rise_from [get_clocks {SYSCLK}] -rise_to [get_clocks {TRNG_DIV_2_CLK}] -hold 0.230
set_clock_uncertainty -rise_from [get_clocks {SYSCLK}] -fall_to [get_clocks {TRNG_DIV_2_CLK}] -setup 0.240
set_clock_uncertainty -rise_from [get_clocks {SYSCLK}] -fall_to [get_clocks {TRNG_DIV_2_CLK}] -hold 0.230
set_clock_uncertainty -rise_from [get_clocks {SYSCLK}] -rise_to [get_clocks {TRNG_ENTROPY_CLK}] -setup 0.180
set_clock_uncertainty -rise_from [get_clocks {SYSCLK}] -rise_to [get_clocks {TRNG_ENTROPY_CLK}] -hold 0.170
set_clock_uncertainty -rise_from [get_clocks {SYSCLK}] -fall_to [get_clocks {TRNG_ENTROPY_CLK}] -setup 0.180
set_clock_uncertainty -rise_from [get_clocks {SYSCLK}] -fall_to [get_clocks {TRNG_ENTROPY_CLK}] -hold 0.170
set_clock_uncertainty -rise_from [get_clocks {SYSCLK}] -rise_to [get_clocks {RTC_1HZ_CLK}]  0.220
set_clock_uncertainty -rise_from [get_clocks {SYSCLK}] -fall_to [get_clocks {RTC_1HZ_CLK}]  0.220
...
set_clock_uncertainty -fall_from [get_clocks {SYSCLK}] -rise_to [get_clocks {TRACE_CLK}] -setup 0.080
set_clock_uncertainty -fall_from [get_clocks {SYSCLK}] -rise_to [get_clocks {TRACE_CLK}] -hold 0.060
set_clock_uncertainty -fall_from [get_clocks {SYSCLK}] -fall_to [get_clocks {TRACE_CLK}] -setup 0.080
set_clock_uncertainty -fall_from [get_clocks {SYSCLK}] -fall_to [get_clocks {TRACE_CLK}] -hold 0.060
set_clock_uncertainty -fall_from [get_clocks {SYSCLK}] -rise_to [get_clocks {TRNG_DIV_8_CLK}] -setup 0.310
set_clock_uncertainty -fall_from [get_clocks {SYSCLK}] -rise_to [get_clocks {TRNG_DIV_8_CLK}] -hold 0.300
set_clock_uncertainty -fall_from [get_clocks {SYSCLK}] -fall_to [get_clocks {TRNG_DIV_8_CLK}] -setup 0.310
set_clock_uncertainty -fall_from [get_clocks {SYSCLK}] -fall_to [get_clocks {TRNG_DIV_8_CLK}] -hold 0.300
set_clock_uncertainty -fall_from [get_clocks {SYSCLK}] -rise_to [get_clocks {TRNG_DIV_4_CLK}] -setup 0.280
set_clock_uncertainty -fall_from [get_clocks {SYSCLK}] -rise_to [get_clocks {TRNG_DIV_4_CLK}] -hold 0.270
set_clock_uncertainty -fall_from [get_clocks {SYSCLK}] -fall_to [get_clocks {TRNG_DIV_4_CLK}] -setup 0.280
set_clock_uncertainty -fall_from [get_clocks {SYSCLK}] -fall_to [get_clocks {TRNG_DIV_4_CLK}] -hold 0.270
set_clock_uncertainty -fall_from [get_clocks {SYSCLK}] -rise_to [get_clocks {TRNG_DIV_2_CLK}] -setup 0.240
set_clock_uncertainty -fall_from [get_clocks {SYSCLK}] -rise_to [get_clocks {TRNG_DIV_2_CLK}] -hold 0.230
set_clock_uncertainty -fall_from [get_clocks {SYSCLK}] -fall_to [get_clocks {TRNG_DIV_2_CLK}] -setup 0.240
set_clock_uncertainty -fall_from [get_clocks {SYSCLK}] -fall_to [get_clocks {TRNG_DIV_2_CLK}] -hold 0.230
set_clock_uncertainty -fall_from [get_clocks {SYSCLK}] -rise_to [get_clocks {TRNG_ENTROPY_CLK}] -setup 0.180
set_clock_uncertainty -fall_from [get_clocks {SYSCLK}] -rise_to [get_clocks {TRNG_ENTROPY_CLK}] -hold 0.170
set_clock_uncertainty -fall_from [get_clocks {SYSCLK}] -fall_to [get_clocks {TRNG_ENTROPY_CLK}] -setup 0.180
set_clock_uncertainty -fall_from [get_clocks {SYSCLK}] -fall_to [get_clocks {TRNG_ENTROPY_CLK}] -hold 0.170
set_clock_uncertainty -fall_from [get_clocks {SYSCLK}] -rise_to [get_clocks {RTC_1HZ_CLK}]  0.220
set_clock_uncertainty -fall_from [get_clocks {SYSCLK}] -fall_to [get_clocks {RTC_1HZ_CLK}]  0.220
...
set_clock_uncertainty -rise_from [get_clocks {TRACE_CLK}] -rise_to [get_clocks {SYSCLK}] -setup 0.080
set_clock_uncertainty -rise_from [get_clocks {TRACE_CLK}] -rise_to [get_clocks {SYSCLK}] -hold 0.060
set_clock_uncertainty -rise_from [get_clocks {TRACE_CLK}] -fall_to [get_clocks {SYSCLK}] -setup 0.080
set_clock_uncertainty -rise_from [get_clocks {TRACE_CLK}] -fall_to [get_clocks {SYSCLK}] -hold 0.060
set_clock_uncertainty -rise_from [get_clocks {TRACE_CLK}] -rise_to [get_clocks {TRACE_CLK}] -setup 0.080
set_clock_uncertainty -rise_from [get_clocks {TRACE_CLK}] -rise_to [get_clocks {TRACE_CLK}] -hold 0.060
set_clock_uncertainty -rise_from [get_clocks {TRACE_CLK}] -fall_to [get_clocks {TRACE_CLK}] -setup 0.080
set_clock_uncertainty -rise_from [get_clocks {TRACE_CLK}] -fall_to [get_clocks {TRACE_CLK}] -hold 0.060
set_clock_uncertainty -fall_from [get_clocks {TRACE_CLK}] -rise_to [get_clocks {SYSCLK}] -setup 0.080
set_clock_uncertainty -fall_from [get_clocks {TRACE_CLK}] -rise_to [get_clocks {SYSCLK}] -hold 0.060
set_clock_uncertainty -fall_from [get_clocks {TRACE_CLK}] -fall_to [get_clocks {SYSCLK}] -setup 0.080
set_clock_uncertainty -fall_from [get_clocks {TRACE_CLK}] -fall_to [get_clocks {SYSCLK}] -hold 0.060
set_clock_uncertainty -fall_from [get_clocks {TRACE_CLK}] -rise_to [get_clocks {TRACE_CLK}] -setup 0.080
set_clock_uncertainty -fall_from [get_clocks {TRACE_CLK}] -rise_to [get_clocks {TRACE_CLK}] -hold 0.060
set_clock_uncertainty -fall_from [get_clocks {TRACE_CLK}] -fall_to [get_clocks {TRACE_CLK}] -setup 0.080
set_clock_uncertainty -fall_from [get_clocks {TRACE_CLK}] -fall_to [get_clocks {TRACE_CLK}] -hold 0.060
...
set_clock_uncertainty -rise_from [get_clocks {TRNG_DIV_8_CLK}] -rise_to [get_clocks {SYSCLK}] -setup 0.310
set_clock_uncertainty -rise_from [get_clocks {TRNG_DIV_8_CLK}] -rise_to [get_clocks {SYSCLK}] -hold 0.300
set_clock_uncertainty -rise_from [get_clocks {TRNG_DIV_8_CLK}] -fall_to [get_clocks {SYSCLK}] -setup 0.310
set_clock_uncertainty -rise_from [get_clocks {TRNG_DIV_8_CLK}] -fall_to [get_clocks {SYSCLK}] -hold 0.300
set_clock_uncertainty -rise_from [get_clocks {TRNG_DIV_8_CLK}] -rise_to [get_clocks {TRNG_DIV_8_CLK}]  0.540
set_clock_uncertainty -rise_from [get_clocks {TRNG_DIV_8_CLK}] -fall_to [get_clocks {TRNG_DIV_8_CLK}]  0.540
set_clock_uncertainty -rise_from [get_clocks {TRNG_DIV_8_CLK}] -rise_to [get_clocks {TRNG_DIV_4_CLK}]  0.510
set_clock_uncertainty -rise_from [get_clocks {TRNG_DIV_8_CLK}] -fall_to [get_clocks {TRNG_DIV_4_CLK}]  0.510
set_clock_uncertainty -fall_from [get_clocks {TRNG_DIV_8_CLK}] -rise_to [get_clocks {SYSCLK}] -setup 0.310
set_clock_uncertainty -fall_from [get_clocks {TRNG_DIV_8_CLK}] -rise_to [get_clocks {SYSCLK}] -hold 0.300
set_clock_uncertainty -fall_from [get_clocks {TRNG_DIV_8_CLK}] -fall_to [get_clocks {SYSCLK}] -setup 0.310
set_clock_uncertainty -fall_from [get_clocks {TRNG_DIV_8_CLK}] -fall_to [get_clocks {SYSCLK}] -hold 0.300
set_clock_uncertainty -fall_from [get_clocks {TRNG_DIV_8_CLK}] -rise_to [get_clocks {TRNG_DIV_8_CLK}]  0.540
set_clock_uncertainty -fall_from [get_clocks {TRNG_DIV_8_CLK}] -fall_to [get_clocks {TRNG_DIV_8_CLK}]  0.540
set_clock_uncertainty -fall_from [get_clocks {TRNG_DIV_8_CLK}] -rise_to [get_clocks {TRNG_DIV_4_CLK}]  0.510
set_clock_uncertainty -fall_from [get_clocks {TRNG_DIV_8_CLK}] -fall_to [get_clocks {TRNG_DIV_4_CLK}]  0.510
set_clock_uncertainty -rise_from [get_clocks {TRNG_DIV_4_CLK}] -rise_to [get_clocks {TRNG_DIV_2_CLK}]  0.430
set_clock_uncertainty -rise_from [get_clocks {TRNG_DIV_4_CLK}] -fall_to [get_clocks {TRNG_DIV_2_CLK}]  0.430
set_clock_uncertainty -fall_from [get_clocks {TRNG_DIV_4_CLK}] -rise_to [get_clocks {TRNG_DIV_2_CLK}]  0.430
set_clock_uncertainty -fall_from [get_clocks {TRNG_DIV_4_CLK}] -fall_to [get_clocks {TRNG_DIV_2_CLK}]  0.430
set_clock_uncertainty -rise_from [get_clocks {TRNG_DIV_2_CLK}] -rise_to [get_clocks {TRNG_ENTROPY_CLK}]  0.330
set_clock_uncertainty -rise_from [get_clocks {TRNG_DIV_2_CLK}] -fall_to [get_clocks {TRNG_ENTROPY_CLK}]  0.330
set_clock_uncertainty -fall_from [get_clocks {TRNG_DIV_2_CLK}] -rise_to [get_clocks {TRNG_ENTROPY_CLK}]  0.330
set_clock_uncertainty -fall_from [get_clocks {TRNG_DIV_2_CLK}] -fall_to [get_clocks {TRNG_ENTROPY_CLK}]  0.330
set_clock_uncertainty -rise_from [get_clocks {TRNG_ENTROPY_CLK}] -rise_to [get_clocks {SYSCLK}] -setup 0.180
set_clock_uncertainty -rise_from [get_clocks {TRNG_ENTROPY_CLK}] -rise_to [get_clocks {SYSCLK}] -hold 0.170
set_clock_uncertainty -rise_from [get_clocks {TRNG_ENTROPY_CLK}] -fall_to [get_clocks {SYSCLK}] -setup 0.180
set_clock_uncertainty -rise_from [get_clocks {TRNG_ENTROPY_CLK}] -fall_to [get_clocks {SYSCLK}] -hold 0.170
set_clock_uncertainty -fall_from [get_clocks {TRNG_ENTROPY_CLK}] -rise_to [get_clocks {SYSCLK}] -setup 0.180
set_clock_uncertainty -fall_from [get_clocks {TRNG_ENTROPY_CLK}] -rise_to [get_clocks {SYSCLK}] -hold 0.170
set_clock_uncertainty -fall_from [get_clocks {TRNG_ENTROPY_CLK}] -fall_to [get_clocks {SYSCLK}] -setup 0.180
set_clock_uncertainty -fall_from [get_clocks {TRNG_ENTROPY_CLK}] -fall_to [get_clocks {SYSCLK}] -hold 0.170
set_clock_uncertainty -rise_from [get_clocks {RTC_1HZ_CLK}] -rise_to [get_clocks {AUDSCLK}] -setup 0.190
set_clock_uncertainty -rise_from [get_clocks {RTC_1HZ_CLK}] -rise_to [get_clocks {AUDSCLK}] -hold 0.170
set_clock_uncertainty -rise_from [get_clocks {RTC_1HZ_CLK}] -fall_to [get_clocks {AUDSCLK}] -setup 0.190
set_clock_uncertainty -rise_from [get_clocks {RTC_1HZ_CLK}] -fall_to [get_clocks {AUDSCLK}] -hold 0.170
set_clock_uncertainty -rise_from [get_clocks {RTC_1HZ_CLK}] -rise_to [get_clocks {SYSCLK}]  0.220
set_clock_uncertainty -rise_from [get_clocks {RTC_1HZ_CLK}] -fall_to [get_clocks {SYSCLK}]  0.220
set_clock_uncertainty -rise_from [get_clocks {RTC_1HZ_CLK}] -rise_to [get_clocks {RTC_1HZ_CLK}] -setup 0.290
set_clock_uncertainty -rise_from [get_clocks {RTC_1HZ_CLK}] -rise_to [get_clocks {RTC_1HZ_CLK}] -hold 0.280
set_clock_uncertainty -rise_from [get_clocks {RTC_1HZ_CLK}] -fall_to [get_clocks {RTC_1HZ_CLK}] -setup 0.290
set_clock_uncertainty -rise_from [get_clocks {RTC_1HZ_CLK}] -fall_to [get_clocks {RTC_1HZ_CLK}] -hold 0.280
set_clock_uncertainty -fall_from [get_clocks {RTC_1HZ_CLK}] -rise_to [get_clocks {AUDSCLK}] -setup 0.190
set_clock_uncertainty -fall_from [get_clocks {RTC_1HZ_CLK}] -rise_to [get_clocks {AUDSCLK}] -hold 0.170
set_clock_uncertainty -fall_from [get_clocks {RTC_1HZ_CLK}] -fall_to [get_clocks {AUDSCLK}] -setup 0.190
set_clock_uncertainty -fall_from [get_clocks {RTC_1HZ_CLK}] -fall_to [get_clocks {AUDSCLK}] -hold 0.170
set_clock_uncertainty -fall_from [get_clocks {RTC_1HZ_CLK}] -rise_to [get_clocks {SYSCLK}]  0.220
set_clock_uncertainty -fall_from [get_clocks {RTC_1HZ_CLK}] -fall_to [get_clocks {SYSCLK}]  0.220
set_clock_uncertainty -fall_from [get_clocks {RTC_1HZ_CLK}] -rise_to [get_clocks {RTC_1HZ_CLK}] -setup 0.290
set_clock_uncertainty -fall_from [get_clocks {RTC_1HZ_CLK}] -rise_to [get_clocks {RTC_1HZ_CLK}] -hold 0.280
set_clock_uncertainty -fall_from [get_clocks {RTC_1HZ_CLK}] -fall_to [get_clocks {RTC_1HZ_CLK}] -setup 0.290
set_clock_uncertainty -fall_from [get_clocks {RTC_1HZ_CLK}] -fall_to [get_clocks {RTC_1HZ_CLK}] -hold 0.280
...
set_clock_uncertainty -rise_from [get_clocks {zbt_gen_clock}] -rise_to [get_clocks {SYSCLK}] -setup 0.140
set_clock_uncertainty -rise_from [get_clocks {zbt_gen_clock}] -rise_to [get_clocks {SYSCLK}] -hold 0.130
set_clock_uncertainty -rise_from [get_clocks {zbt_gen_clock}] -fall_to [get_clocks {SYSCLK}] -setup 0.140
set_clock_uncertainty -rise_from [get_clocks {zbt_gen_clock}] -fall_to [get_clocks {SYSCLK}] -hold 0.130
set_clock_uncertainty -fall_from [get_clocks {zbt_gen_clock}] -rise_to [get_clocks {SYSCLK}] -setup 0.140
set_clock_uncertainty -fall_from [get_clocks {zbt_gen_clock}] -rise_to [get_clocks {SYSCLK}] -hold 0.130
set_clock_uncertainty -fall_from [get_clocks {zbt_gen_clock}] -fall_to [get_clocks {SYSCLK}] -setup 0.140
set_clock_uncertainty -fall_from [get_clocks {zbt_gen_clock}] -fall_to [get_clocks {SYSCLK}] -hold 0.130
...
set_input_delay -add_delay -min -clock [get_clocks {SYSCLK}]  3.000 [get_ports {EXP[0]}]
...
set_input_delay -add_delay -min -clock [get_clocks {SYSCLK}]  3.000 [get_ports {EXP[23]}]
...
set_input_delay -add_delay -min -clock [get_clocks {SYSCLK}]  3.000 [get_ports {EXP[26]}]
...
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQP[0]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQP[0]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQP[1]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQP[1]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQP[2]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQP[2]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQP[3]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQP[3]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQP[4]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQP[4]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQP[5]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQP[5]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQP[6]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQP[6]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQP[7]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQP[7]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[0]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[0]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[1]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[1]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[2]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[2]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[3]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[3]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[4]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[4]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[5]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[5]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[6]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[6]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[7]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[7]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[8]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[8]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[9]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[9]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[10]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[10]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[11]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[11]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[12]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[12]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[13]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[13]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[14]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[14]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[15]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[15]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[16]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[16]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[17]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[17]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[18]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[18]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[19]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[19]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[20]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[20]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[21]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[21]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[22]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[22]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[23]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[23]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[24]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[24]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[25]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[25]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[26]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[26]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[27]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[27]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[28]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[28]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[29]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[29]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[30]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[30]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[31]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[31]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[32]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[32]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[33]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[33]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[34]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[34]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[35]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[35]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[36]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[36]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[37]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[37]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[38]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[38]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[39]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[39]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[40]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[40]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[41]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[41]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[42]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[42]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[43]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[43]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[44]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[44]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[45]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[45]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[46]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[46]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[47]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[47]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[48]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[48]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[49]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[49]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[50]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[50]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[51]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[51]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[52]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[52]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[53]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[53]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[54]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[54]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[55]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[55]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[56]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[56]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[57]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[57]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[58]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[58]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[59]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[59]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[60]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[60]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[61]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[61]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[62]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[62]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM1_DQ[63]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM1_DQ[63]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQP[0]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQP[0]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQP[1]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQP[1]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQP[2]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQP[2]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQP[3]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQP[3]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[0]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[0]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[1]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[1]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[2]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[2]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[3]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[3]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[4]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[4]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[5]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[5]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[6]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[6]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[7]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[7]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[8]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[8]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[9]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[9]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[10]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[10]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[11]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[11]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[12]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[12]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[13]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[13]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[14]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[14]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[15]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[15]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[16]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[16]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[17]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[17]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[18]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[18]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[19]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[19]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[20]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[20]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[21]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[21]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[22]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[22]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[23]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[23]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[24]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[24]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[25]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[25]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[26]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[26]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[27]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[27]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[28]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[28]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[29]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[29]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[30]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[30]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM2_DQ[31]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM2_DQ[31]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQP[0]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQP[0]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQP[1]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQP[1]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQP[2]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQP[2]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQP[3]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQP[3]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[0]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[0]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[1]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[1]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[2]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[2]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[3]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[3]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[4]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[4]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[5]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[5]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[6]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[6]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[7]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[7]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[8]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[8]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[9]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[9]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[10]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[10]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[11]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[11]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[12]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[12]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[13]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[13]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[14]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[14]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[15]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[15]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[16]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[16]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[17]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[17]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[18]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[18]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[19]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[19]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[20]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[20]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[21]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[21]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[22]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[22]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[23]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[23]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[24]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[24]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[25]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[25]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[26]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[26]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[27]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[27]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[28]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[28]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[29]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[29]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[30]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[30]}]
set_input_delay -add_delay -max -clock [get_clocks {zbt_gen_clock}]  8.500 [get_ports {SSRAM3_DQ[31]}]
set_input_delay -add_delay -min -clock [get_clocks {zbt_gen_clock}]  2.000 [get_ports {SSRAM3_DQ[31]}]
...
set_output_delay -add_delay -max -clock [get_clocks {TRACE_CLK}]  10.000 [get_ports {CS_TRACECLK}]
set_output_delay -add_delay -min -clock [get_clocks {TRACE_CLK}]  -1.000 [get_ports {CS_TRACECLK}]
set_output_delay -add_delay -max -clock [get_clocks {TRACE_CLK}]  10.000 [get_ports {CS_TRACECTL}]
set_output_delay -add_delay -min -clock [get_clocks {TRACE_CLK}]  -1.000 [get_ports {CS_TRACECTL}]
set_output_delay -add_delay -max -clock [get_clocks {TRACE_CLK}]  10.000 [get_ports {CS_TRACEDATA[0]}]
set_output_delay -add_delay -min -clock [get_clocks {TRACE_CLK}]  -1.000 [get_ports {CS_TRACEDATA[0]}]
set_output_delay -add_delay -max -clock [get_clocks {TRACE_CLK}]  10.000 [get_ports {CS_TRACEDATA[1]}]
set_output_delay -add_delay -min -clock [get_clocks {TRACE_CLK}]  -1.000 [get_ports {CS_TRACEDATA[1]}]
set_output_delay -add_delay -max -clock [get_clocks {TRACE_CLK}]  10.000 [get_ports {CS_TRACEDATA[2]}]
set_output_delay -add_delay -min -clock [get_clocks {TRACE_CLK}]  -1.000 [get_ports {CS_TRACEDATA[2]}]
set_output_delay -add_delay -max -clock [get_clocks {TRACE_CLK}]  10.000 [get_ports {CS_TRACEDATA[3]}]
set_output_delay -add_delay -min -clock [get_clocks {TRACE_CLK}]  -1.000 [get_ports {CS_TRACEDATA[3]}]
set_output_delay -add_delay -max -clock [get_clocks {TRACE_CLK}]  10.000 [get_ports {CS_TRACEDATA[4]}]
set_output_delay -add_delay -min -clock [get_clocks {TRACE_CLK}]  -1.000 [get_ports {CS_TRACEDATA[4]}]
set_output_delay -add_delay -max -clock [get_clocks {TRACE_CLK}]  10.000 [get_ports {CS_TRACEDATA[5]}]
set_output_delay -add_delay -min -clock [get_clocks {TRACE_CLK}]  -1.000 [get_ports {CS_TRACEDATA[5]}]
set_output_delay -add_delay -max -clock [get_clocks {TRACE_CLK}]  10.000 [get_ports {CS_TRACEDATA[6]}]
set_output_delay -add_delay -min -clock [get_clocks {TRACE_CLK}]  -1.000 [get_ports {CS_TRACEDATA[6]}]
set_output_delay -add_delay -max -clock [get_clocks {TRACE_CLK}]  10.000 [get_ports {CS_TRACEDATA[7]}]
set_output_delay -add_delay -min -clock [get_clocks {TRACE_CLK}]  -1.000 [get_ports {CS_TRACEDATA[7]}]
set_output_delay -add_delay -max -clock [get_clocks {TRACE_CLK}]  10.000 [get_ports {CS_TRACEDATA[8]}]
set_output_delay -add_delay -min -clock [get_clocks {TRACE_CLK}]  -1.000 [get_ports {CS_TRACEDATA[8]}]
set_output_delay -add_delay -max -clock [get_clocks {TRACE_CLK}]  10.000 [get_ports {CS_TRACEDATA[9]}]
set_output_delay -add_delay -min -clock [get_clocks {TRACE_CLK}]  -1.000 [get_ports {CS_TRACEDATA[9]}]
set_output_delay -add_delay -max -clock [get_clocks {TRACE_CLK}]  10.000 [get_ports {CS_TRACEDATA[10]}]
set_output_delay -add_delay -min -clock [get_clocks {TRACE_CLK}]  -1.000 [get_ports {CS_TRACEDATA[10]}]
set_output_delay -add_delay -max -clock [get_clocks {TRACE_CLK}]  10.000 [get_ports {CS_TRACEDATA[11]}]
set_output_delay -add_delay -min -clock [get_clocks {TRACE_CLK}]  -1.000 [get_ports {CS_TRACEDATA[11]}]
set_output_delay -add_delay -max -clock [get_clocks {TRACE_CLK}]  10.000 [get_ports {CS_TRACEDATA[12]}]
set_output_delay -add_delay -min -clock [get_clocks {TRACE_CLK}]  -1.000 [get_ports {CS_TRACEDATA[12]}]
set_output_delay -add_delay -max -clock [get_clocks {TRACE_CLK}]  10.000 [get_ports {CS_TRACEDATA[13]}]
set_output_delay -add_delay -min -clock [get_clocks {TRACE_CLK}]  -1.000 [get_ports {CS_TRACEDATA[13]}]
set_output_delay -add_delay -max -clock [get_clocks {TRACE_CLK}]  10.000 [get_ports {CS_TRACEDATA[14]}]
set_output_delay -add_delay -min -clock [get_clocks {TRACE_CLK}]  -1.000 [get_ports {CS_TRACEDATA[14]}]
set_output_delay -add_delay -max -clock [get_clocks {TRACE_CLK}]  10.000 [get_ports {CS_TRACEDATA[15]}]
set_output_delay -add_delay -min -clock [get_clocks {TRACE_CLK}]  -1.000 [get_ports {CS_TRACEDATA[15]}]
...
set_output_delay -add_delay -max -clock [get_clocks {SYSCLK}]  21.000 [get_ports {FPGA_CONFIG_nLRST}]
set_output_delay -add_delay -min -clock [get_clocks {SYSCLK}]  0.000 [get_ports {FPGA_CONFIG_nLRST}]
...
set_clock_groups -asynchronous -group [get_clocks {OSCCLK0 SYSCLK}] -group [get_clocks {OSCCLK1 AUDMCLK AUDSCLK}] -group [get_clocks {OSCCLK2}] -group [get_clocks {DBGCLK}] -group [get_clocks {SPICFGCLK}] -group [get_clocks {CFGCLK}]
